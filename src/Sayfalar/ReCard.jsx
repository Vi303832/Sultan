            ...
            <div className='flex h-full w-full  max-lg:flex-col justify-center items-center '>
                ...
                <div className='w-[50%] h-full p-12 flex flex-col max-sm:items-center gap-8 text-start max-lg:w-full max-xs:pb-10 max-xs:p-0'>
                    ...
                    <button onClick={() => navigate(`/${url}`)} className='flex gap-2 px-8 py-2 text-beyaz justify-center items-center font-arial text-md font-light bg-altin opacity-80 min-xl:w-[70%] max-lg:w-[60%] max-md:w-[70%] max-sm:w-[100%] max-xs:!w-[70%] '>
                        <div className='flex gap-1 items-center px-1  cursor-pointer max-xs:text-center max-xxs:text-sm max-xs:flex-wrap'><span className='flex gap-1'>{url} <div>Organizasyonlarını</div></span>inceleyin<FaArrowRightLong /> </div>
                    </button>
                </div>
